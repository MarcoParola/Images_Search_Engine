...
% ---------------------------------- FEATURES EXTRACTION -------------------------------------
\section{Extract features from the images}
...
Looking at the accuacy plot of the first experiment, we can observe the presence of overfitting phenomenon; in order to reduce this problem, we added some \textit{Dropout Layer}.\\
