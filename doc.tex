...
\hline
Resnet50 & 0.715 & 1.085 & 0.718 & 0.999 & 32791 \\
\hline
\end{tabular}
\end{center}
...
\hline
\textbf{Euclidian mAP} & 0.561 & 0.562 & 0.701 & 0.917 & 0.658 \\
\hline
...
\textbf{Class} &  0 - drawings & 1 - engraving & 2 - iconography & 3 - painting & 4 - sculpture\\
\hline
\textbf{Euclidian mAP} & 0.549 & 0.554 & 0.690 & 0.914 & 0.639 \\
\hline
...
\end{center}
\vspace{2mm}
From the previous tables we can observe a very small decrease in the mAP values introducing the distractor both using the euclidian distance and the cosine similarity.
...
k = 10 &  mAP euclidian & avg dist & mAP cosine & avg sim & $\#$Items\\
\hline
Resnet50v2 & 0.893 & 17.986 & 0.902 & 0.747 & 32791 \\
\hline
\end{tabular}
\end{center}
...
\textbf{Class} &  0 - drawings & 1 - engraving & 2 - iconography & 3 - painting & 4 - sculpture\\
\hline
\textbf{Euclidian mAP} & 0.686 & 0.698 & 0.984 & 0.953 & 0.929 \\
\hline
...
\textbf{Class} &  0 - drawings & 1 - engraving & 2 - iconography & 3 - painting & 4 - sculpture\\
\hline
\textbf{Euclidian mAP} & 0.682 & 0.696 & 0.984 & 0.947 & 0.918 \\
\hline
...
\vspace{3mm}
From the previous tables we can observe a very small decrease in the mAP values introducing the distractor both using the euclidian distance and the cosine similarity.\\
Moreover it is interesting to notice that using Resnet50v2 to extract the features from the images, the average distance computed using the euclidian distance between objects is higher than the one computed using Resnet50 (about 1600\%), while the overall performance of the sequential scan search (measured by the mAP) is better, about 16\%.
